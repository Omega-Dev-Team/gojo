...
fn withdrawal_gas_limit() -> felt252 {
    hash_poseidon_single('WITHDRAWAL_GAS_LIMIT')
}
...
fn position_impact_factor() -> felt252 {
    hash_poseidon_single('POS_IMPACT_FACTOR')
}
...
fn max_position_impact_factor_for_liquidations() -> felt252 {
    hash_poseidon_single('MAX_POS_IMPFACT_FOR_LIQ')
}
...
fn max_pnl_factor_for_traders() -> felt252 {
    hash_poseidon_single('MAX_PNL_FACTOR_FOR_TRADERS')
}
...
fn max_pnl_factor_for_withdrawals() -> felt252 {
    hash_poseidon_single('MAX_PNL_FACTOR_FOR_WITHDRAWALS')
}
...
fn funding_fee_amount_per_size() -> felt252 {
    hash_poseidon_single('FUNDING_FEE_AMOUNT_PER_SIZE')
}
...
fn claimable_collateral_amount() -> felt252 {
    hash_poseidon_single('CLAIMABLE_COLL_AMT')
}
