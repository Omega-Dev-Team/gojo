...
trait IExchangeRouter<TContractState> {
    ...
    /// # This function is responsible for building the user interface (UI).
    /// # It includes logic to calculate and apply any associated fees for the UI construction process.
